...
public class FeatureBarHelper {
    ...
    public void wrapDecor(final Activity activity) {
        ...
        mBackKey.setOnClickListener(v -> sendDownAndUpKeyEvents(activity, KeyEvent.KEYCODE_BACK));
        mOptionsKey.setClickable(true);
        mOptionsKey.setOnClickListener(v -> sendDownAndUpKeyEvents(activity, KeyEvent.KEYCODE_MENU));
        mCenterKey.setClickable(true);
        mCenterKey.setOnClickListener(v -> sendDownAndUpKeyEvents(activity, KeyEvent.KEYCODE_DPAD_CENTER));

        // TODO
        //if(activity.getActionBar() != null) {
        //    activity.getActionBar().addOnMenuVisibilityListener(isVisible -> {
        //        if (isVisible) {
